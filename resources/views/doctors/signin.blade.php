				...
				<div class="col s12 m8 offset-m2 l6 offset-l3">
					<div class="card large white darken-1" style="height: auto;" ng-hide="signin_card">
						<div class="card-content black-text center">
							...
							<h4 class="center"><b>Doctor's Account</b></h4>
							<h6>Enter your credentials</h6>
							<br><br>
							<form action="{{ url('doctor/sigin') }}" method="POST">
								<div class="col s12 m8 offset-m2 l8 offset-l2">
									<div class="input-field"> 
										<div class="form-group">
											<label class="control-label" for="">Email Address</label>
											<span class="help-block"></span>
											<input type="email" class="form-control" ng-model="data.email" name="email" placeholder="Email Address">
										</div>
									</div>
									<div class="input-field"> 
										<div class="form-group">
								...
								<div class="col s12 m8 offset-m2 l8 offset-l2">
									<br>
									{{ csrf_field() }}
									<button type="submit" ng-disabled="!data.email || !data.password" class="btn btn-large">Continue <i class="material-icons right">arrow_forward</i></button>
								</div>
								<div class="section"></div>
							</form>
							</div>
